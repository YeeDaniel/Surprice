    ...
    <div class="min-h-screen bg-gray-100 px-4 py-6 flex justify-center">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-b-xl shadow-md p-4">
          ...
          <input v-model="product.name" class="form-input mb-3" placeholder="牛肉三明治" />
  
          <div class="flex space-x-2 mb-3">
            <div class="w-1/2">
              <label class="block text-sm font-medium text-gray-700 mb-1">商品類型</label>
            ...
            <div class="w-1/2">
              <label class="block text-sm font-medium text-gray-700 mb-1">商品數量</label>
          ...
          <div class="flex space-x-2 mb-3">
            <div class="w-1/2">
              <label class="block text-sm font-medium text-gray-700 mb-1">原定價格</label>
              <input v-model="product.originalPrice" class="form-input" placeholder="100" />
            </div>
            <div class="w-1/2">
              <label class="block text-sm font-medium text-gray-700 mb-1">優惠價格</label>
              <input v-model="product.discountPrice" class="form-input" placeholder="60" />
            </div>
          </div>
  
          <label class="block text-sm font-medium text-gray-700 mb-1">優惠時段</label>
          ...
          <div class="flex items-center mb-4">
            <input type="checkbox" v-model="product.isFeatured" class="form-checkbox text-green-600 mr-2" />
